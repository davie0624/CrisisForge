...
**Technical research report · Independent research project v0.3.0 ·
28 July 2026**
...
The repository contains the Python package, YAML configurations, tests, report
source, and figure-generation script. Estimator equations and scope limitations
are documented in `docs/mathematical_formulation.md`; source fields, availability
lags, and licensing notes are in `docs/data_dictionary.md`; and the research
background is in `docs/literature_review.md`.

Downloaded data, row-level derived data, checkpoints, and run outputs are generated
locally and are not redistributed. Report figures are reproduced with
